  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 max-w-5xl items-center">
        ...
        <nav className="hidden md:flex gap-6"> {/* Removed ml-auto to align left */}
          {navItems.map((item) => (
            <Link
              key={item.label}
              href={item.href}
        ...
        <div className="ml-auto md:hidden"> {/* This ml-auto pushes the mobile menu to the right, and it's hidden on md+ screens */}
          <Sheet>
